...
roteador.options('/', (requisicao,reposta)=> {
...
roteador.options('/:id', (requisicao,reposta)=> {
...
roteador.put('./', async (requisicao,resposta, proximo) => {
    try {
...
roteador.options('/:id/diminuir-estoque', (requisicao,reposta)=> {
